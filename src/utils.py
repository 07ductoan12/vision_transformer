...
def save_experiment(
    ...
    save_checkpoint(experiment_name, model, "final.pt", base_dir=base_dir)


def save_checkpoint(experiment_name, model, name_checkpoints, base_dir="experiments"):
    outdir = os.path.join(base_dir, experiment_name)
    os.makedirs(outdir, exist_ok=True)
    cpfile = os.path.join(outdir, name_checkpoints)
